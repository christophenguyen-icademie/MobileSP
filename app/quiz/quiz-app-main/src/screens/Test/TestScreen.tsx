...
import { convertJsonToArrayOfQuestion, Question } from "../../data/types";
...
export function TestScreen({ navigation, route }: TestScreenProps) {
  ...
  useEffect(() => {
    setQuestions(shuffleArray(convertJsonToArrayOfQuestion(category)));
...
interface PagerViewComponentProps {
  questions: Question[];
  pagerViewRef: React.RefObject<PagerViewRef>;
